...
| 4.2 | `scripts/simulate_set_day.py`: labeled simulation publishing a day's events at speed for the video | `scripts/simulate_set_day.py` | Stephen | 🟡 WIP | 4.1 | Runs against the live cluster | WIP 2026-09-03 00:08 Stephen: script and test at 09b991a against the in-process bus; the live-cluster run waits on 4.1 |
