...
| # | Task | Files | Owner | Status | Deps | Done means | Notes |
|---|---|---|---|---|---|---|---|
| 5.1 | Wired-or-cut audit: grep the shipped code for every tool, model and vendor named in README, `/judge`, `.env.example`, `AGENTS.md` and the submission draft; cut or reword until claimed equals invoked | `docs/claims-audit.md` | Stephen | 🟡 WIP | 3.7 | Audit committed; zero unwired claims | WIP 2026-09-03 11:20 Stephen: `.env.example` half done at f101736 (VITE_API_BASE cut, HOLD_URL added, the enterprise flag's comment corrected) and held by `api/tests/test_env_template.py`; README, AGENTS.md and the submission draft remain, plus the audit file |
