...
| 0.4 | Devpost project draft, track IBM, Deem invited as team member | n/a | Stephen | ✅ DONE | n/a | Draft visible to both | DONE 2026-09-03 13:05 Stephen: draft created through the Devpost API at https://devpost.com/software/hold-wrp4nq (project 1415567, draft submission 1169291 to agentic-cinema) with tagline, description, built-with and links; the track and the custom questions are answered at submit time (6.3); the team invite for Deem is not available over the API and is done on the web |
