...
| 1.7 | CI job `residual` runs 1.1, 1.4, 1.5, 1.6 with no network and no key, 15-minute job timeout, uploads `bench/results.json`; README badge | `.github/workflows/ci.yml`, `README.md` | Stephen | WIP | 1.4, 1.6 | Badge green on main | WIP 2026-09-03 Stephen - pushing now |
