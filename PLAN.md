...
| 0.6 | Bob `/init`; `.bob/custom_modes.yaml` with the five write-scoped modes (regexes in the Lanes section); `.bob/rules-*/AGENTS.md`; root `AGENTS.md`; `.bobignore` | `.bob/**`, `AGENTS.md`, `.bobignore` | Stephen | WIP | 0.5 | Each mode refuses one file outside its scope and accepts one inside (all five tested) | WIP 2026-09-03 Stephen |
