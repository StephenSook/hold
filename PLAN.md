...
| # | Task | Files | Owner | Status | Deps | Done means | Notes |
|---|---|---|---|---|---|---|---|
| 5.1 | Wired-or-cut audit: grep the shipped code for every tool, model and vendor named in README, `/judge`, `.env.example`, `AGENTS.md` and the submission draft; cut or reword until claimed equals invoked | `docs/claims-audit.md` | Stephen | 🟡 WIP | 3.7 | Audit committed; zero unwired claims | WIP 2026-09-03 12:30 Stephen: `.env.example` at f101736 (held by `api/tests/test_env_template.py`); README and AGENTS.md at 35db32b (three dead paths and the unbuilt MCP server claim fixed, held by `api/tests/test_readme_paths.py`); the submission draft and `docs/claims-audit.md` remain, written once 0.4 exists |
