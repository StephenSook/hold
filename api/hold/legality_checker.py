...
from api.hold.registry import RuleRecord, is_penalty_record, is_trust_record, load_rules
...
def rule_applies_to_minor(rule: RuleRecord, minor: CastMember, shoot_state: str) -> bool:
    ...
    if rule.id in DISPLAY_ONLY_RULE_IDS or is_trust_record(rule) or is_penalty_record(rule):
        return False
